...
| Scenario | WACC | Terminal Growth (g) | Enterprise Value ($m) | Offer Price (p) | Sentiment |
|-----------|------|---------------------|------------------------|-----------------|------------|
| Management Case | 8.5% | 0.5% | **1,204** | **563** | Positive / Base |
| JPM Outside-In | 9.0% | 0.25% | **1,096** | **508** | Neutral / Conservative |
| Post-Fire Revised | 8.5% | 0.5% | **738** | **329** | Negative / Sentiment-Adjusted |
